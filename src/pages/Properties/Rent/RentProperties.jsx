...
import { Plus, Search, Filter, Eye, Edit, Trash2, Home, Calendar } from "lucide-react"
...
const RentProperties = () => {
  ...
  const { data, isLoading, isFetching } = useGetPropertiesAdminQuery({ page, limit: 10, search: searchTerm, propertyFor: "Rent" })
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-bold text-neutral-900">Rent Properties</h1>
          <p className="text-neutral-600 mt-1">Manage properties for rent</p>
        </div>
            ...
            <Card key={property._id} padding={false} hover>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 mb-2">
                  <Badge variant="warning">For Rent</Badge>
