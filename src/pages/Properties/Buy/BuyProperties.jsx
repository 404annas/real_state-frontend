...
const BuyProperties = () => {
  ...
  const { data, isLoading, isFetching } = useGetPropertiesAdminQuery({ page, limit: 10, search: searchTerm, propertyFor: "Buy" })
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-bold text-neutral-900">Buy Properties</h1>
